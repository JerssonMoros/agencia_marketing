...
function Navbar(){
    return(
        <nav className='w-full py-5 shadow-md fixed'>
            ...
            <div className="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap">
                ...
                <div>
                    <h3 className="text-lg inline-flex leading-6 text-gray-900 mx-8">Blog</h3>
                    <h3 className="text-lg inline-flex leading-6 text-gray-900 mx-8">Community</h3>
                    <h3 className="text-lg inline-flex leading-6 text-gray-900 mx-8">Support</h3>
                </div>
